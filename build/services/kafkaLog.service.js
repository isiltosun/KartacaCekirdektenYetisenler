...
var KafkaProducerService = /** @class */ (function () {
    function KafkaProducerService() {
        ...
        this.producer.connect().then(function () { return console.info("Producer connected..."); });
    ...
    KafkaProducerService.prototype.sendLog = function (logData) {
