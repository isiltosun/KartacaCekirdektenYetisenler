...
var KafkaConsumerService = /** @class */ (function () {
    function KafkaConsumerService() {
        ...
        this.consumer.connect().then(function () { return console.info("Consumer connected"); });
    }
    KafkaConsumerService.prototype.startConsumer = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.consumer.subscribe({
                            topic: 'logs',
                            fromBeginning: true
                        })];
                    case 1:
                                ...
                                eachMessage: function (_a) {
                                    ...
                                    return __awaiter(_this, void 0, void 0, function () {
                                        ...
                                        return __generator(this, function (_b) {
                                            switch (_b.label) {
                                                case 0:
                                                    if (!message.value) return [3 /*break*/, 2];
                                                    logData = JSON.parse(message.value.toString());
                                                    return [4 /*yield*/, db_1.insertLog(db_1.pool, logData)];
                                                case 1:
                                                    _b.sent();
                                                    _b.label = 2;
